...
function drawRowAdd(data){
    ...
    row.append("<td><a href='#' class='add_celula_membro' data-membro-id='"+ data.membro.id +"' data-celula-id='"+ data.celula.id +"'><i class='fa fa-plus'></i></a> </td>");
    return row;
}
...
function drawRowRemove(data){
    var row = $("<tr />");
    row.append("<td>"+data.membro.nome +"</td>");
    row.append("<td><a href='#' class='remove_celula_membro' data-membro-id='"+ data.membro.id +"' data-celula-membro-id='"+ data.id +"' data-celula-id='"+ data.celula.id +"'><i class='fa fa-remove'></i></a> </td>");
    return row;
}
